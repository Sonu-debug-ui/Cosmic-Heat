...
class BulletRefill(pygame.sprite.Sprite):
    def __init__(self, x, y, image):
        ...
        self.sound_effect.set_volume(current_settings["sound_effects"])
...
class UnlimitedBulletRefill(pygame.sprite.Sprite):
    def __init__(self, x, y, image):
        super().__init__()
        self.image = image
        self.rect = self.image.get_rect()
        ...
        self.sound_effect.set_volume(current_settings["sound_effects"])
        self.duration = 5000  # 5 seconds of unlimited bullets
...
class FireRateUpgrade(pygame.sprite.Sprite):
    def __init__(self, x, y, image):
        super().__init__()
        self.image = image
        self.rect = self.image.get_rect()
        ...
        self.direction_y = random.choice([-2, 2])
        self.sound_effect = pygame.mixer.Sound(
            "game_sounds/refill/extra_score.mp3"
        )  # Placeholder sound
        self.sound_effect.set_volume(current_settings["sound_effects"])
